      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <motion.p
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-ink/50 max-w-xl mx-auto mt-6 text-lg"
          >
            ...
            >
              ...
              <div className="mb-8">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-ink/50 text-lg font-medium">$</span>
                  <span className="text-5xl font-display font-bold">{plan.price}</span>
                  <span className="text-ink/30 text-sm font-medium uppercase tracking-widest ml-1">Starting</span>
                </div>
              </div>
              ...
              <Link 
                ...
                className={`w-full py-4 rounded-2xl font-bold flex items-center justify-center gap-2 group transition-all ${
                  plan.popular ? "bg-ink text-bg hover:bg-accent hover:text-white" : "bg-ink/5 text-ink hover:bg-ink/10"
                }`}
              >
                Get Started
